...
export default function SubjectModal({ isOpenSubjectModal, closeSubjectModal, id, checkReLoading, setCheckReLoading }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      res = await subjectApi.updateSubject(id, data)
      if (res.EC != 1) {
...
SubjectModal.propTypes = {
  isOpenSubjectModal: PropTypes.any,
  closeSubjectModal: PropTypes.any,
