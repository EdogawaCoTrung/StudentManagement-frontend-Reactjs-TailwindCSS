            ...
            let filteredData = res.DT.map((student) => {
                let filteredSummaries = student.summaries.map((summary) => {
                    let filteredSubjectResults = summary.subjectresults.filter(
                        (subjectResult) =>
                            subjectResult.subject.subjectname.toLowerCase() ===
                ...
                <div className="fixed inset-0 flex items-center justify-center align-middle ">
                    <div className="">
                        ...
                        <Dialog.Panel className="flex h-fit w-auto transform flex-col rounded-2xl bg-white text-left font-Manrope shadow-xl transition-all">
                            ...
                            <div className="flex h-fit w-auto transform flex-col rounded-2xl bg-white text-left font-Manrope shadow-xl transition-all">
                       <div className=" flex h-screen flex-col overflow-y-auto">
                            <div className=" flex items-center justify-between">
                                <div className="flex">
                                    <p className="animate-fade-down font-Manrope text-2xl font-bold text-gradeTitle p-10">
                                        Điểm số
                                    </p>
                                </div>
                            </div>
                            {dataTerm1 && (
                                <div className=" flex w-full items-center rounded-lg bg-white shadow-xl">
                                    ...
                                    <div className="flex flex-1 flex-col pr-5">
                                        <p className="font-Manrope text-4xl font-bold">
                                            {dataTerm1[0]?.student.studentname}
                                        </p>
                                        <div className="mt-3 flex flex-row items-center justify-between">
                                            <div className="mr-2 flex w-full flex-col rounded-lg border-2 p-2">
                                                <p className="font-Manrope text-base">
                                                    ...
                                                    {dataTerm1[0]?.student.User.email}
                                                </p>
                                                <p className="font-Manrope text-base">
                            ...
                            <div className="relative mt-10 flex flex-col">
                                <Tab.Group>
                                    ...
                                    <Tab.Panels>
                                        ...
                                        <Tab.Panel>
                                            {data && <Overall listSubjectResult={data}></Overall>}
                                        </Tab.Panel>
                                    </Tab.Panels>
                                </Tab.Group>
                            </div>
