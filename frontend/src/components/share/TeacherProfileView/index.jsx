            ...
            <div className="flex items-center p-4">
                <div className="flex h-fit w-auto transform flex-col rounded-2xl bg-white p-10 text-left font-Manrope shadow-xl transition-all">
                    <div className="flex h-fit w-auto flex-row">
                        <Avatar src={/* teacher.User.image ||*/ "/teacher.png"} alt="teacher" sx={{ height: 150, width: 150, border: "solid" }} />
                    ...
                    <div>
                        <div>
                            <div className="flex flex-row">
                                <p className="pl-10" style={{ fontSize: "18px", marginTop: "20px" }}>{`Ngày bắt đầu: ${formatDate(teacher.startDate)}`}</p>
                                <p className="pl-10 pr-10" style={{ fontSize: "18px", marginTop: "20px", marginLeft: "120px" }}>{`Giới tính: ${teacher.gender === "0" ? "Nam" : "Nữ"}`}</p>                           
                            </div>
                            <p className="pl-10" style={{fontSize: "18px", marginTop: "20px"}}>{`Môn học phụ trách: ${subject.subjectname}`}</p>
                            <p className="pl-10" style={{ fontSize: "18px", marginTop: "20px" }}>{`Trạng thái trong năm: ${teacher.statusinyear === 0 ? "Chưa hoàn thành" : "Đã hoàn thành"}`}</p>
