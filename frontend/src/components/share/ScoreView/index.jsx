      ...
      let filteredData = res.DT.map((student) => {
        let filteredSummaries = student.summaries.map((summary) => {
          let filteredSubjectResults = summary.subjectresults.filter(
            (subjectResult) => subjectResult.subject.subjectname.toLowerCase() === subjectName.toLowerCase(),
          )
          return {
            ...summary,
                  ...
                  <div className="flex h-fit w-auto transform flex-col rounded-2xl bg-white text-left font-Manrope shadow-xl transition-all">
                    <div className=" flex h-screen flex-col overflow-y-auto">
                      <div className=" flex items-center justify-between">
                        <div className="flex">
                          <p className="animate-fade-down p-10 font-Manrope text-2xl font-bold text-gradeTitle">
                            Điểm số
                          </p>
                        </div>
                      </div>
